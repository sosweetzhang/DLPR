...
class LearnerGroup(MetaInfinityLearnerGroup):
    ...
    def __next__(self):
        ...
        random_list = [random.uniform(-3, 0.5) for _ in range(len(knowledge))]
        ...
        return Learner(
            ...
            set(self.random_state.choice(len(knowledge), self.random_state.randint(1, int(0.5 * len(knowledge))))),
