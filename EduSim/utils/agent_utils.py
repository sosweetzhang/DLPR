...
def get_raw_data_path():
    ...
    return cur_path[:cur_path.find('IDALPR')] + 'IDALPR' + "/data/dataDemo"


def get_proj_path(proj_name='IDALPR'):
    """
    :param item_name: 
    :return:
    """
...
def batch_cat_targets(KT_states, targets, num_skills):
    target_tensor = mindspore.ops.zeros((KT_states.shape[0], num_skills), dtype=mindspore.float32)
    ...
    return mindspore.ops.cat((KT_states, target_tensor), 1)  # [batch_size, 2*action_dim]
